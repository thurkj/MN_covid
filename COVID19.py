...
dataset['schooling'] = 'Elementary and MS/HS in-person'
dataset.loc[(dataset['ratio']>=10) & (dataset['ratio']<20), 'schooling'] = 'Elementary in-person, MS/HS hybrid'
dataset.loc[(dataset['ratio']>=20) & (dataset['ratio']<30), 'schooling'] = 'Elementary and MS/HS hybrid'
dataset.loc[(dataset['ratio']>=30) & (dataset['ratio']<50), 'schooling'] = 'Elementary hybrid, MS/HS distance'
dataset.loc[(dataset['ratio']>=50), 'schooling'] = 'Elementary and MS/HS distance'
...
fig_map = px.choropleth(df, geojson=counties, locations='FIPS', color='schooling',
                           color_discrete_map={
                            'Elementary and MS/HS in-person':'green',
                            'Elementary in-person, MS/HS hybrid':'tan',
                            'Elementary and MS/HS hybrid':'yellow',
                            'Elementary hybrid, MS/HS distance':'orange',
                            'Elementary and MS/HS distance':'red'},
                           category_orders = {
                            'schooling':['Elementary and MS/HS in-person',
                            'Elementary in-person, MS/HS hybrid',
                            'Elementary and MS/HS hybrid',
                            'Elementary hybrid, MS/HS distance',
                            'Elementary and MS/HS distance']},
                           projection = "mercator",
